...
function mostarSegundos (){
    console.log(seconds);

}

//comenzarCuentaRegresiva(mostarSegundos);
//*(coment)eliminamos el conosiiento de mostarr segundos Se elimina la dependencia con callback 
//comenzarCuentaRegresiva(mostarSegundos);//comenzarCuentaRegresiva();
 ...
 *  
 */
// tener claro qie existe una repercucion en el flujo de la     de forma asyncrona 
...
async function comprar (){
    ...
    const segundaCompra = await comprarTresEmpanadasConAcync(empanadasAsync);
    console.log(`empanadas :  ${segundaCompra}`);
    const terceraCompra = await comprarCincoEmpanadasConAcync(empanadasAsync);
    console.log(`empanadas :  ${terceraCompra}`);
}
